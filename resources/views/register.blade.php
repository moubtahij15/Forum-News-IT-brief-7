        ...
        <div class="flex min-h-screen items-center justify-center">
            ...
            <div class="min-h-1/2 bg-gray-900  border border-gray-900 rounded-2xl">
                ...
                <div
                    ...
                    <h1 class="text-white text-2xl">Join us now</h1>
                    <input class="w-full p-2 bg-gray-900 rounded-md  border border-gray-700 focus:border-blue-700"
                        placeholder="name" type="text" name="correo" id="">
                    <input class="w-full p-2 bg-gray-900 rounded-md border border-gray-700 " placeholder="last name"
                        type="text" name="correo" id="">
                    <input class="w-full p-2 bg-gray-900 rounded-md  border border-gray-700 focus:border-blue-700"
                        placeholder="email" type="email" name="correo" id="">
                    <input class="w-full p-2 bg-gray-900 rounded-md border border-gray-700 " placeholder="date naissance"
                        type="date" name="correo" id="">
                    ...
                    <p>don't have an account ? 
                        <a class="font-semibold text-sky-700" href="">create</a>
                    </p>
                </div>
