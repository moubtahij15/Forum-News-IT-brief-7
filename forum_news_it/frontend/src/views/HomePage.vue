    ...
    v-for="elem in $store.state.post.data.posts" :key="elem.id">
      ...
      <div class=" h-16 border-b  flex items-center justify-around	">
        ...
        <div class="flex items-center	gap-3">
          ...
          <div  v-for="ele in elem.likes" :key="ele.id"> 
      ...
      <!-- comment -->
          <!-- post a comment -->
          <div class="relative flex items-center self-center w-full max-w-xxl p-4 overflow-hidden text-gray-600 focus-within:text-gray-400">
                    ...
                    <span class="absolute inset-y-0 right-0 flex items-center pr-6">
                     ...
                     <input type="search" class="w-full py-2 pl-4 pr-10 text-sm bg-gray-100 border border-transparent appearance-none rounded-tg placeholder-gray-400 focus:bg-white focus:outline-none focus:border-blue-500 focus:text-gray-900 focus:shadow-outline-blue" style="border-radius: 25px" placeholder="Post a comment..." autocomplete="off" v-model="comment.sjt_comments">
               <div class="-mr-1">
               <input type='submit'   class="bg-white text-gray-700 font-medium py-1 px-4 border border-gray-400 rounded-lg tracking-wide mr-1 hover:bg-gray-100" value='Post Comment' @click="setComment(elem)" >
            </div>
              </div>
